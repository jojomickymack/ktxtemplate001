...
class Game(private val stage: Stage, val application: Application) : KtxScreen {
    private val backgroundImage = Texture("snake.png")
    private val view = table {
        setFillParent(true)

        background = TextureRegionDrawable(TextureRegion(backgroundImage, 0, 0, 600, 600))
        touchable = enabled
        //onClick { application.setScreen<OtherScreen>() }
